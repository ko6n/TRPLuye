              ...
              <div class="card">
               ...
               <div class="card-content">
                ...
                <div class="form-group">
                  ...
                  <label class="control-label col-sm-2" for="name" style="font-size: 10px;">Nama Desain</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control Desain_c" id="Desain_id" name="Desain" placeholder="Enter Tile"  value="{{old('Desain') }}">

                    @if ($errors->has('Desain')) <p class="help-block">{{ $errors->first('Desain') }}</p> @endif
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2" for="pwd" style="font-size: 10px;">File Upload</label>
                ...
                <div class="form-group">        
                  <div class="col-sm-offset-2 col-sm-1"><br>
                    <button type="submit" class="waves-effect waves-light btn">Submit</button>
                  </div>
                <div class="col-sm-offset-2 col-sm-1" style="margin-left: 10px;"><br>
                    <a href="lihatPerancangan" type="submit" class="waves-effect waves-light btn">Lihat</a>
                </div>
                </div>
