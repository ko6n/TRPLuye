...
<li><a href="/masuk"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
    ...
    <form class="col s12" action="{{ url('ubahpemesananPerakitan') }}&{{ $pemesanan->id_pemesanan }}">
     {{ csrf_field() }}   
      

         <div class="row">
        <div class="input-field col s8">
            <select id="status" name="status_jadi" class="required" required="">
              <option value="{{ $pemesanan->status_jadi }}">- Pilih Status -</option>
      ...
      <br><br><button class="waves-effect waves-light btn" style="width: 100px;">Simpan</button>
