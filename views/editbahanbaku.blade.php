...
<li><a href="/masuk"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="formbahanbaku" class="active-menu waves-effect waves-dark"><i class="fa fa-qrcode"></i> Bahan Baku</a>
                    </li>
                    <li>
    ...
    <form class="col s12" action="{{ url('ubahbahanbaku') }}&{{ $bahanbaku->id_bahanbaku }}">
     {{ csrf_field() }}   
     
      <div class="row">
        <div class="input-field col s8"><br>
          <input id="namabarang" type="text" name="namabahan" value="{{ $bahanbaku->namabahan }}" required="">
          <label for="first_name">Nama Bahan </label>
        </div>
        <div class="input-field col s8"><br>
          <input id="jumlahbahan" type="number" name="jumlah" value="{{ $bahanbaku->jumlah }}" required="">
